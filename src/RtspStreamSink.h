...
class RtspStreamSink {
  ...
  public:
    ...
    GstElement* getTSDemuxPtr() { return _tsdemux; };
    GstElement* getPipelinePtr() { return _pipeline; };
    GstElement* getTeePtr() { return _tee; };
    GstElement* getRtpDepayPtr() { return _rtpdepay; };
    GstElement* getSourcePtr() { return _src; };
    GstElement* getHlsSinkPtr() { return _hlssink; };
    GstElement* getHlsQueuePtr() { return _hlsqueue; };
    GstElement* getParserPtr() { return _parser; };
    GstElement* getSourceSinkPtr() { return _sourcesink; };
    GstElement* getParserQueuePtr() { return _parserqueue; };
    void setPipelinePtr(GstElement* pipeline ) { _pipeline = pipeline; };
    void setParserPtr(GstElement* parser) { _parser = parser; };
  ...
  protected:
    RtspStreamSink() {};
    bool hasExited() { return _exit_service;  };

    // wen called generates and returns the current time stamp
    std::string getName() { return _info.name; };
    std::string getUploadUrl() { return _uploadUrl; };
    std::string getHlsFilename() { return _hlsFilename; };
    std::string getHlsPlaylist() { return _hlsPlaylist; };
    std::string getCurrentHlsDir() { return _currentHlsDir; };
    std::string getArchDir() { return _archivedir; };
    std::string getCurrentArchDir() { return _currentArchDir; };
    std::string getTimeStampStr() { return _datetimeStr; };
    std::string getFilenamePathTs() { return _filenamePathTs; };
    StreamType getStreamType() { return _info.type; };
