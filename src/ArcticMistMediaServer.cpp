...
bool parseConfigFile( std::string filename, StreamNames& list, std::string& archiveDir, std::string& hlsDir, std::string& url, std::string& portrange ) {
...
int main ( int argc, char** argv ) {
   ...
   if( archdir.empty() || snames.size() == 0 ) { //|| uploadurl.empty()
   ...
   std::cerr << "Exiting ArcticmistMediaServer\n";
   return 0;
};
